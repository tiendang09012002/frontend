  ...
  return (
    <div id="sidebar-collapse" className="col-sm-3 col-lg-2 sidebar">
      ...
      <ul className="nav menu">
        ...
        <li><a href="/users"><svg className="glyph stroked male user "><use xlinkHref="#stroked-male-user" /></svg>Quản lý thành viên</a></li>
        ...
        <li><a href="/products"><svg className="glyph stroked bag"><use xlinkHref="#stroked-bag" /></svg>Quản lý sản phẩm</a></li>
